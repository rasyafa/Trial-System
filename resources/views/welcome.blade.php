    ...
    <div class="min-h-screen flex flex-col items-center justify-center">
        ...
        <nav class="w-full bg-white shadow-lg fixed top-0">
            <div class="container mx-auto px-6 py-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-green-500 hover:text-green-800">Login</a>
                        <a href="{{ route('register') }}"
                            class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-700">Register</a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <div class="container mx-auto px-6 pt-32 pb-12">
            <div class="text-center">
                ...
                <div class="mt-12">
                    <a href="{{ route('register') }}"
                        class="bg-green-500 text-white px-8 py-3 rounded-lg text-lg hover:bg-green-700 transition duration-300">
                        Mulai Sekarang
                    </a>
                </div>
            </div>
